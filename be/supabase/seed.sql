...
begin
  ...
  values
    ...
    ('10000000-0000-4000-8000-000000000004', 4, 'Tầng 4', admin_user_id, admin_user_id)
  ...
  foreach floor_id in array array[
    ...
    values
      (floor_id, case when floor_id::text = '10000000-0000-4000-8000-000000000001' then '101' when floor_id::text = '10000000-0000-4000-8000-000000000002' then '201' else '301' end, case when floor_id::text = '10000000-0000-4000-8000-000000000003' then 2 else 3 end, true, null, 'triple-left-elevator', admin_user_id, admin_user_id),
      ...
      (floor_id, case when floor_id::text = '10000000-0000-4000-8000-000000000001' then '105' when floor_id::text = '10000000-0000-4000-8000-000000000002' then '205' else '305' end, 2, true, null, 'standard', admin_user_id, admin_user_id)
  ...
  insert into public.rooms (floor_id, room_number, bed_count, has_window, default_nightly_rate, layout_key, created_by, updated_by)
  values
    ('10000000-0000-4000-8000-000000000004', '4A', 1, false, null, 'fourth-floor-a', admin_user_id, admin_user_id),
    ('10000000-0000-4000-8000-000000000004', '4B', 2, true, null, 'fourth-floor-b', admin_user_id, admin_user_id)
  on conflict (room_number) do update
    set floor_id = excluded.floor_id,
        bed_count = excluded.bed_count,
        has_window = excluded.has_window,
